...
```
uv run gofile-downloader.py [https://gofile.io/d/contentid](https://gofile.io/d/contentid)
```

If it has password:

```
uv run gofile-downloader.py [https://gofile.io/d/contentid](https://gofile.io/d/contentid) password
```

If you have a text file with multiple urls:

```
[https://gofile.io/d/contentid1](https://gofile.io/d/contentid1)
[https://gofile.io/d/contentid2](https://gofile.io/d/contentid2)
[https://gofile.io/d/contentid3](https://gofile.io/d/contentid3)
[https://gofile.io/d/contentid4](https://gofile.io/d/contentid4)
```
...
```
[https://gofile.io/d/contentid1](https://gofile.io/d/contentid1) password1
[https://gofile.io/d/contentid2](https://gofile.io/d/contentid2)
[https://gofile.io/d/contentid3](https://gofile.io/d/contentid3)
[https://gofile.io/d/contentid4](https://gofile.io/d/contentid4) password4
```
